        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).exists()) {
                    ...
                    TextView clientz = rootView.findViewById(R.id.clients_text);
                    TextView produtz = rootView.findViewById(R.id.productz_text);
                    TextView deliveriz = rootView.findViewById(R.id.delivery_text);

                    clientz.setText(clients_no);
